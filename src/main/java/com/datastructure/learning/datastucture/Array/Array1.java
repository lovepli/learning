...
/**
 * @auth0r: james
 * @date: 2019-05-29 23:23 制作属于我们的数组类，实现增删改查 普通数组，这里定义了只能存储 int类型的数据结构
 */
public class Array1 {
  ...
  /** 向所有元素后面添加一个新的元素e 即向size处添加元素 数组中有三个元素，则索引为0,1,2 ，所以是向size处添加元素 */
  ...
  public int remove(int index) {
    // 传入的参数错误异常IllegalArgumentException  索引越界
    if (index < 0 || index > size) {
